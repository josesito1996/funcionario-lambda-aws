...
public interface MateriaService extends ICrud<Materia, String> {
    ...
    Map<String, Object> materiaPieChartResponses(String intendencia,String desde,String hasta);
    
    Map<String, Object> materiaPieChartSancionadasResponses(String intendencia,String desde,String hasta);
}
